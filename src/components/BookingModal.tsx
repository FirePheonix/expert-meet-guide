      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle className="flex items-center space-x-3">
            ...
            />
            <div>
              <div className="font-semibold">Chat with {expert.name}</div>
        ...
        <div className="space-y-4">
          <div className="bg-blue-50 p-3 rounded-lg">
            <div className="flex items-center space-x-2 mb-1">
              ...
              <span className="font-medium text-sm">Google Meet Call</span>
            </div>
          ...
          <div>
            <Label className="text-sm">How long?</Label>
          ...
          <div>
            <Label htmlFor="topic" className="text-sm">What do you need help with?</Label>
            <Textarea
              id="topic"
